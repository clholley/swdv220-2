...
SELECT media_name, release_date, group_name
FROM Media
	JOIN MediaHasArtist	
		ON Media.media_id = MediaHasArtist.media_id
	JOIN Artist
...
SELECT borrower_fname, borrower_lname, media_name
FROM Borrower
	JOIN HasBorrower	
...
SELECT Media.media_id, media_name, COUNT(checkout_date) as 'Times Borrowed'
FROM Media
	JOIN HasBorrower	
	ON HasBorrower.media_id = Media.media_id
...
SELECT media_name, checkout_date, return_date, borrower_lname
FROM Media
	JOIN HasBorrower
